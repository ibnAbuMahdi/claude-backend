...
MIDDLEWARE = [
    ...
    'apps.middleware.APILoggingMiddleware',  # Add API logging middleware
...
WSGI_APPLICATION = 'stika.wsgi.application'

DATABASES = {
    'default': dj_database_url.config(
        default='postgis://stika_user:password@localhost:5432/stika_db',
        conn_max_age=600,
...
MEDIA_URL = '/media/'
# Use persistent volume path for production, local path for development
if DEBUG:
    MEDIA_ROOT = BASE_DIR / 'media'
else:
    MEDIA_ROOT = '/app/media'  # This will be mounted to the fly.io volume
...
# DRF Spectacular settings (as per plan)
SPECTACULAR_SETTINGS = {
    'TITLE': 'Stika API',
    'DESCRIPTION': 'B2B2B Tricycle Advertising Platform API',
    'VERSION': '1.0.0',
...
# GraphQL settings (as per plan)
GRAPHENE = {
    'SCHEMA': 'stika.schema.schema',
    'MIDDLEWARE': [
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@stika.ng')
